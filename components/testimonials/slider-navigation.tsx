  ...
  return (
    <div className={`flex w-full items-center gap-[15px] ${alignClass}`}>
      <button
        type="button"
        onClick={onPrevious}
        className="w-10 h-10 sm:w-[48px] sm:h-[48px] rounded-full bg-fs-background sm:bg-white border border-fs-purple flex items-center justify-center transition-transform duration-150 sm:hover:-translate-y-[1px] active:translate-y-0"
        aria-label="Previous"
      >
