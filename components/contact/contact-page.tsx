...
function OfficesSection() {
  return (
    <section className="fs-container mx-auto mt-[90px] flex flex-col items-center gap-[50px] px-4 sm:px-6">
      <div className="flex max-w-[880px] flex-col items-center gap-[20px] text-center">
        <Badge>Our Offices</Badge>
        <h2 className="font-heading text-h2 font-medium leading-h2 text-fs-dark sm:text-[40px] sm:font-normal sm:leading-[48px] lg:text-[48px] lg:leading-[58px] lg:tracking-[-3.8267px]">
          Discover Our Global Network of Offices
        </h2>
        <p className="font-body text-[16px] leading-[22px] text-fs-grey">
          Experience our expansive network of offices across the world, connecting you to our exceptional services wherever you are.
        </p>
      </div>

      <div className="grid w-full gap-8 rounded-blog border border-fs-border bg-white px-5 py-6 sm:px-10 sm:py-10 lg:grid-cols-3 lg:px-[65px] lg:py-[47px]">
        {offices.map((office) => (
          <article key={office.city} className="flex flex-col gap-[30px]">
            <div className="relative h-[210px] overflow-hidden rounded-[8px] sm:h-[301px]">
              <Image src={office.imageSrc} alt={office.imageAlt} fill sizes="(max-width: 1058px) 100vw, 330px" className="object-cover" />
            </div>
...
function FaqSection() {
  return (
    <section className="fs-container mx-auto mt-[90px] flex flex-col items-center gap-[50px] px-4 sm:px-6">
      <div className="flex max-w-[800px] flex-col items-center gap-[20px] text-center">
        <Badge>FAQs</Badge>
        <h2 className="font-heading text-h2 font-medium leading-h2 text-fs-dark sm:text-[40px] sm:font-normal sm:leading-[48px] lg:text-[48px] lg:leading-[58px] lg:tracking-[-3.8267px]">
