...
export default function ViewAllLink({ href = "#" }: ViewAllLinkProps) {
  return (
    <a href={href} className="group flex items-center gap-[8px]">
      ...
      <svg className="transition-transform duration-200 sm:group-hover:translate-x-[4px]" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
